...
class GoogleSecretManagerMapping(Mapping[str, Optional[str]]):
    ...
    def __init__(
        self, secret_client: SecretManagerServiceClient, project_id: str
    ) -> None:
    ...
    def _secret_names(self) -> list[str]:
        return [
            ...
            for secret in self._secret_client.list_secrets(
                parent=self._gcp_project_path
            )
        ]
...
class GoogleSecretManagerSettingsSource(EnvSettingsSource):
    ...
    def _load_env_vars(self) -> Mapping[str, Optional[str]]:
        return GoogleSecretManagerMapping(
            self._secret_client, project_id=self._project_id
        )
